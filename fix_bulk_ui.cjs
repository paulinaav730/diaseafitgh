            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3 bg-[#FAF6EC]/50 p-2.5 px-4 rounded-xl border border-[#EADDC7]">
              ...
              {selectedAssignmentIds.length > 0 && (
                <button
                  ...
                  className="flex items-center justify-center gap-1.5 px-3 py-1.5 bg-[#B83A24] hover:bg-[#9E2F1B] text-white rounded-lg text-xs font-bold shadow-sm transition-colors"
                >
...
console.log('Fixed bulk delete UI');
