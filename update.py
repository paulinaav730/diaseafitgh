...
with open('src/data/eventStructure.ts', 'r', encoding='utf-8') as f:
    c = f.read()

replacement = '''export const THE_GAMES_JUEVES_BASES: ConfigurableBase[] = Array.from({ length: 15 }, (_, i) => ({
...
c = re.sub(r'export const THE_GAMES_PHYSICAL_BASES.*?\];', replacement, c, flags=re.DOTALL)

with open('src/data/eventStructure.ts', 'w', encoding='utf-8') as f:
    f.write(c)
